function waldo = find_waldo(scenario, ref)
%%
% Limpeza do ambiente
clc, clear, close all;
...
figure,imshow(color_image(max(1,coords(1)-100):min(ih, coords(1)+100), max(1,coords(2)-100):min(iw, coords(2)+100), :)), title('Waldo!');
end