...
image = imread('scenarios\wheresWaldo1.jpg');
...
roi = bwareaopen(roi, floor(ih/150 * iw/150));
bigger = bwareaopen(roi, floor(ih/100 * iw/100));
roi = roi - bigger;
...
locus_x = round(centroids(6,2));
locus_y = round(centroids(6,1));
